...
public class PurchaseInfoDto extends RequestPageDto{
    /**
     * 查询AS/WOODAUTO编号
     */
    ...
    public String getMatchAS() {
        return matchAS;
    }

    public void setMatchAS(String matchAS) {
        this.matchAS = matchAS;
    }

    public String getMatchWOODAUTO() {
        return matchWOODAUTO;
    }

    public void setMatchWOODAUTO(String matchWOODAUTO) {
        this.matchWOODAUTO = matchWOODAUTO;
    }
